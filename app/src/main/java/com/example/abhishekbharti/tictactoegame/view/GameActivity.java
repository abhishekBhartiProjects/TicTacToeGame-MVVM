...
import com.example.abhishekbharti.tictactoegame.databinding.ActivityGameBinding;
import com.example.abhishekbharti.tictactoegame.model.Player;
import com.example.abhishekbharti.tictactoegame.viewmodel.GameViewModel;

import static com.example.abhishekbharti.tictactoegame.utilities.StringUtility.isNullOrEmpty;

public class GameActivity extends AppCompatActivity {

    private static final String GAME_BEGIN_DIALOG_TAG = "begin_dialog_tag";
    ...
    public void promptsForPlayers(){
        GameBeginDialog gameBeginDialog = GameBeginDialog.newInstance(this);
        gameBeginDialog.setCancelable(false);
        gameBeginDialog.show(getSupportFragmentManager(), GAME_BEGIN_DIALOG_TAG);
    }

    public void onPlayersSet(String player1, String player2){initDataBinding(player1, player2);}
